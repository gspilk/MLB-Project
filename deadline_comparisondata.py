...
# filling out the remaining spots. Matches the Aug 2026 breakdown:
# Ferrer/Speier/Bazardo/Munoz (core) + Rucker/Wilcox/Simpson, plus
# Dominguez (newly acquired, added manually below since he's not in the
# scraped leaderboard data yet).
